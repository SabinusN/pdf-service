...
router.get('/scene/export-simple/pdf-example', function(req, res){
    ...
    await page.screenshot({
        ...
        doc.pipe(res);
        //const imageBuffer = new Buffer.from(base64string.replace('data:image/png;base64,',''), 'base64');
        doc.image(base64string, 0, 0, {width:670});
